...
export const Icon = () => {
    return (
        <div className='icons'>
            <a className='icon__link' target="_blank" href="https://github.com/LeaHaelin">
            ...
            <a className='icon__link' target="_blank" href="https://www.frontendmentor.io/profile/LeaHaelin">
            ...
            <a className='icon__link' target="_blank" href="https://www.linkedin.com/in/lea-haelin-kim-41196520a/">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24">
